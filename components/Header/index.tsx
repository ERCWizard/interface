    ...
    <header className="py-8">
      <div className="h-16 flex items-center justify-between">
        <a href="/" className="flex items-center space-x-4">
          <div className="border border-white w-12 h-12 flex items-center justify-center">
            <Image src={wand} width={32} height={32} />
          </div>
          <p className="text-2xl sm:text-4xl">ERC Wizard</p>
        </a>
        <nav>
          <div className="hidden md:flex items-center space-x-4 uppercase">
            ...
            <a
              className="bg-white text-black font-medium px-4 h-12 flex items-center justify-center"
          ...
          <button
            ...
            className="flex md:hidden items-center justify-center bg-white w-12 h-12"
          >
            {isOpen ? (
